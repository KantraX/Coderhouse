class CalcularPromedio {
    ...
    mostrarResultado() {
        ...
        alert(`Hola ${this.nombre}, tu promedio final luego de haber terminado el curso es un ${promedioFinal}.`);

        if (promedioFinal >= 4) {
            alert(`¡Felicitaciones ${this.nombre}! Has aprobado el curso.`);
        } else {
            alert(`${this.nombre}, reprobaste, debes realizar el curso nuevamente. Te recomiendo usar Coderhouse para estudiar.`);
        }
    }
